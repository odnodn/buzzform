              ...
              <div className="space-y-3 p-1">
                <div className="rounded-lg border bg-muted/30 p-3">
                  ...
                  <div className="[&_figure]:my-0!">
                    <pre className="overflow-auto p-4 text-sm"><code>{starterCommand}</code></pre>
                  </div>
                ...
                <div className="[&_figure]:my-0!">
                  <pre className="overflow-auto p-4 text-sm"><code>{componentCode}</code></pre>
                </div>
              </div>
            </ScrollArea>
          </TabsContent>
          ...
          <TabsContent value="json" className="min-h-0 flex-1 overflow-hidden">
            <ScrollArea className="h-full px-4 py-2">
              <div className="space-y-3 p-1">
                ...
                <div className="[&_figure]:my-0!">
                  <pre className="overflow-auto p-4 text-sm"><code>{documentJson}</code></pre>
                </div>
              </div>
            </ScrollArea>
          </TabsContent>
